  ...
  return (
    ...
    <article>
      <div className="container profile-body justify-content-center">
        ...
        <h2 class="introduction text-start mt-2" id="todd-hickam-psu-cs-undergraduate">
          PSU Undergraduate
        </h2>
        ...
        <h2 class="introduction text-start" id="seattle washington">
          Seattle, WA
        </h2>
        <p class="introduction-body text-start">
